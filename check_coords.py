...
def check(coords_orig, coords_app):
    orig_request = f"http://static-maps.yandex.ru/1.x/?pt={coords_app[0]},{coords_app[1]},pmgrs2~{coords_orig[0]},{coords_orig[1]},pmgrs1&pl={coords_app[0]},{coords_app[1]},{coords_orig[0]},{coords_orig[1]}&l=map"
